...
public class AuthService {
	...
	public TokenDTO login(LoginDTO loginDto) {
		...
		return new TokenDTO(token, usuario.getEmail(), usuario.getRol().name(), usuario.getNombre(), usuario.getId());
	}
	...
	public TokenDTO registrar(RegisterDTO registerDto) {
		...
		return new TokenDTO(token, nuevoUsuario.getEmail(), nuevoUsuario.getRol().name(), nuevoUsuario.getNombre(),
				nuevoUsuario.getId());
	}
	...
	public TokenDTO refresh(String email) {
		...
		return new TokenDTO(nuevoToken, usuario.getEmail(), usuario.getRol().name(), usuario.getNombre(),
				usuario.getId());
	}
}